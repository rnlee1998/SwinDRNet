...
parser.add_argument('--train_data_path', type=str,
                    default='/data/ran1998.li/datasets/DREDS/DREDS-CatKnown/val/', help='root dir for training dataset')
...
# parser.add_argument('--val_data_path', type=str,
#                     default='/data/ran1998.li/datasets/STD/STD-CatKnown', help='root dir for data')
# parser.add_argument('--val_data_type', type=str,
...
parser.add_argument('--output_dir', type=str, 
                    default='results/DREDS_CatKnown_origin', help='output dir')
...
device_list = [0]
model_path = "models/1011/swin_seg/checkpoint-iter-00000020.pth"
...
if __name__ == "__main__":
    ...
    # for index,image in enumerate(outputs_depth_list):
    #     plt.imsave(os.path.join(args.output_dir, 'depth','%s.png'%(index)), image, cmap='PuBu')
