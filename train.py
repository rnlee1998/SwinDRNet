...
from networks.SwinDRNet2 import SwinDRNet
...
datename = '%02d%02d'%(date.month,date.day)
...
parser.add_argument('--exp_name', type=str, 
                    default='swinDRNet', help='expand name')
...
args.checkpoint_save_path = 'models/%s/%s'%(datename,args.exp_name)
