...
from .swin_transformer_seg import SwinTransformer
...
class SwinDRNet(nn.Module):
    ...
    def __init__(self, config, img_size=224, num_classes=3):
        ...
        backbone_cfg = dict(
            ...
            frozen_stages=-1)
        # self.backbone_rgb_branch_new = SwinTransformer(**backbone_cfg)
        # self.backbone_xyz_branch_new = SwinTransformer(**backbone_cfg)
    ...
    def forward(self, rgb, depth):
        ...
        # rgb_feature = self.backbone_rgb_branch_new(rgb)
        # depth_feature = self.backbone_xyz_branch_new(depth)
    ...
    def init_weights(self, pretrained=None):
        ...
        # self.backbone_rgb_branch_new.init_weights(pretrained=pretrained)
        # self.backbone_xyz_branch_new.init_weights(pretrained=pretrained)
